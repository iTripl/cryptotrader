...
from exchanges.binance.adapter import BinanceAdapter


class BinanceHistoricalLoader(HistoricalLoader):
    def __init__(self, adapter: BinanceAdapter, checkpoint_path: str) -> None:
